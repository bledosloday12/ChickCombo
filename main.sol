...
contract ChickCombo {
    ...
    function _seedSpeciesCatalog() private {
        ...
        _species[23] = SpeciesGene({
            label: bytes32(0x4e6562756c61596f6c6b00000000000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 9,
            baseTempo: 12,
            element: 7
        });
        _species[24] = SpeciesGene({
            label: bytes32(0x496f6e5065657000000000000000000000000000000000000000000000000000),
            baseMight: 13,
            baseGuard: 8,
            baseTempo: 11,
            element: 4
        });
        _species[25] = SpeciesGene({
            label: bytes32(0x526f6f7447756172640000000000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 13,
            baseTempo: 9,
            element: 3
        });
        _species[26] = SpeciesGene({
            label: bytes32(0x53696c7453747269646572000000000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 10,
            baseTempo: 11,
            element: 6
        });
        _species[27] = SpeciesGene({
            label: bytes32(0x4272696e6546616e670000000000000000000000000000000000000000000000),
            baseMight: 8,
            baseGuard: 10,
            baseTempo: 13,
            element: 2
        });
        _species[28] = SpeciesGene({
            label: bytes32(0x43696e64657243726f776e000000000000000000000000000000000000000000),
            baseMight: 14,
            baseGuard: 9,
            baseTempo: 8,
            element: 1
        });
        _species[29] = SpeciesGene({
            label: bytes32(0x5a6570687972446f776e00000000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 8,
            baseTempo: 14,
            element: 1
        });
        _species[30] = SpeciesGene({
            label: bytes32(0x52756e65526f6f73746572000000000000000000000000000000000000000000),
            baseMight: 11,
            baseGuard: 11,
            baseTempo: 9,
            element: 8
        });
        _species[31] = SpeciesGene({
            label: bytes32(0x4563686f57696e67000000000000000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 9,
            baseTempo: 11,
            element: 7
        });
        _species[32] = SpeciesGene({
            label: bytes32(0x50756c736548656e000000000000000000000000000000000000000000000000),
            baseMight: 12,
            baseGuard: 10,
            baseTempo: 10,
            element: 4
        });
        _species[33] = SpeciesGene({
            label: bytes32(0x4665726e536869656c6400000000000000000000000000000000000000000000),
            baseMight: 8,
            baseGuard: 14,
            baseTempo: 9,
            element: 3
        });
        _species[34] = SpeciesGene({
            label: bytes32(0x426173616c744265616b00000000000000000000000000000000000000000000),
            baseMight: 11,
            baseGuard: 12,
            baseTempo: 8,
            element: 6
        });
        _species[35] = SpeciesGene({
            label: bytes32(0x4d69726167654c61796572000000000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 9,
            baseTempo: 12,
            element: 7
        });
        _species[36] = SpeciesGene({
            label: bytes32(0x54756e64726154616c6f6e730000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 12,
            baseTempo: 10,
            element: 5
        });
        _species[37] = SpeciesGene({
            label: bytes32(0x536f6c6172466c61726500000000000000000000000000000000000000000000),
            baseMight: 15,
            baseGuard: 8,
            baseTempo: 9,
            element: 1
        });
        _species[38] = SpeciesGene({
            label: bytes32(0x4162797373616c436c75636b0000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 11,
            baseTempo: 11,
            element: 2
        });
        _species[39] = SpeciesGene({
            label: bytes32(0x56657264616e74537472696b6500000000000000000000000000000000000000),
            baseMight: 11,
            baseGuard: 9,
            baseTempo: 11,
            element: 3
        });
        _species[40] = SpeciesGene({
            label: bytes32(0x53746f726d437265737400000000000000000000000000000000000000000000),
            baseMight: 13,
            baseGuard: 9,
            baseTempo: 10,
            element: 4
        });
        _species[41] = SpeciesGene({
            label: bytes32(0x4f6273696469616e42726f6f6400000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 13,
            baseTempo: 8,
            element: 6
        });
        _species[42] = SpeciesGene({
            label: bytes32(0x4c756d656e506565700000000000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 10,
            baseTempo: 12,
            element: 8
        });
        _species[43] = SpeciesGene({
            label: bytes32(0x4475736b52756e6e657200000000000000000000000000000000000000000000),
            baseMight: 12,
            baseGuard: 9,
            baseTempo: 10,
            element: 7
        });
        _species[44] = SpeciesGene({
            label: bytes32(0x47616c6553686172640000000000000000000000000000000000000000000000),
            baseMight: 11,
            baseGuard: 10,
            baseTempo: 10,
            element: 4
        });
        _species[45] = SpeciesGene({
            label: bytes32(0x4d6172736857617264656e000000000000000000000000000000000000000000),
            baseMight: 9,
            baseGuard: 12,
            baseTempo: 10,
            element: 3
        });
        _species[46] = SpeciesGene({
            label: bytes32(0x436f72616c43616c6c6572000000000000000000000000000000000000000000),
            baseMight: 8,
            baseGuard: 11,
            baseTempo: 12,
            element: 2
        });
        _species[47] = SpeciesGene({
            label: bytes32(0x456d6265725661756c7400000000000000000000000000000000000000000000),
            baseMight: 12,
            baseGuard: 11,
            baseTempo: 8,
            element: 1
        });
        _species[48] = SpeciesGene({
            label: bytes32(0x49726f6e46656174686572000000000000000000000000000000000000000000),
            baseMight: 10,
            baseGuard: 14,
            baseTempo: 7,
            element: 6
        });
        _species[49] = SpeciesGene({
            label: bytes32(0x566f6964596f6c6b000000000000000000000000000000000000000000000000),
            baseMight: 13,
            baseGuard: 8,
            baseTempo: 11,
            element: 7
